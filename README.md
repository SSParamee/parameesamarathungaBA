...
## 🚀 About the Portfolio
The portfolio demonstrates how I **turn complexity into clarity** by structuring knowledge systems and analytical frameworks that help organisations decide faster and operate smarter.
...
- **Market Repositioning & Content Strategy**  
- **Enterprise ERP Knowledge Management**

---

## 📂 Repository Structure
- `index.html` → Main portfolio site (live showcase of projects, skills, and proof screenshots)  
- `assets/` → Logos, screenshots, and supporting visuals for project case studies  
...
## 📸 Proof of Work
Screenshots and live links are included in the portfolio site (`index.html`) under each project card:
- WSO2 Developer Portal release notes  
- Creately published blogs  
- Healthcare & travel client sites (Headlands, Dipuravana)  
- IFS Confluence wiki articles  
- IFS Copilot agent knowledge architecture  
